...
const DECK_ID = "interactive-lab-formal";
const OUT_DIR = "C:\\Users\\sando\\Desktop\\interactive_lab\\outputs\\interactive-lab-formal";
const REF_DIR = "C:\\Users\\sando\\Desktop\\interactive_lab\\tmp\\slides\\interactive-lab-formal\\references";
...
const SOURCES = {
  pdf: "Interactive Lab.pdf, documento base del equipo.",
  repo: "Repositorio local interactive_lab, estructura backend/frontend/infra.",
  architecture: "docs/architecture/project-foundation.md.",
  erd: "docs/architecture/domain-erd.md.",
  log: "backend-dev-log.txt con evidencia de arranque, rutas y autenticacion.",
};

const SLIDES = [
  {
    "kicker": "IMPLEMENTACION DE LENGUAJES DE PROGRAMACION PARA NEGOCIOS",
    "title": "Interactive Lab",
    "subtitle": "Presentacion formal del desarrollo de la Plataforma de Capacitacion Virtual con Simulacion 3D.",
    "expectedVisual": "Portada formal con equipo completo.",
    "moment": "Equipo de desarrollo",
    "notes": "Portada solicitada con todos los integrantes del equipo y el enfoque formal del proyecto.",
    "sources": [
      "pdf"
    ]
  },
  {
    ...
    "subtitle": "Interactive Lab combina contenido academico, simulacion 3D y medicion de desempeno para capacitar tecnicos desde el navegador.",
    "expectedVisual": "Resumen ejecutivo.",
    "cards": [
      [
        "Objetivo",
        "Desarrollar una plataforma web funcional donde los usuarios ejecuten simulaciones tecnicas 3D y reciban seguimiento de su avance."
      ],
      [
        "Enfoque",
        "La solucion se plantea como una arquitectura web moderna: React para la interfaz, Babylon.js para la escena 3D y Node.js para la API."
      ],
      [
        "Valor",
        "Reduce dependencia de laboratorios fisicos, estandariza practicas y permite generar evidencia de aprendizaje y desempeno."
      ]
    ],
    "notes": "Sintetiza el objetivo central descrito en el PDF y ampliado en la documentacion tecnica.",
    "sources": [
      "pdf",
      "architecture"
    ]
  ...
  {
    "kicker": "02 | TECNOLOGIAS",
    "title": "Stack tecnologico utilizado",
    "subtitle": "La seleccion prioriza integracion web, mantenibilidad y despliegue gradual.",
    "expectedVisual": "Metricas de stack.",
    "metrics": [
      [
        "React",
        "Frontend con Vite, rutas, modulos administrativos y portal de aprendizaje.",
        "React 19 + React Router"
      ],
      [
        "Babylon.js",
        "Motor grafico WebGL para escenarios 3D interactivos dentro del navegador.",
        "Babylon.js 8"
      ],
      [
        "Node.js",
        "Backend NestJS modular con MongoDB, JWT, Fastify y documentacion OpenAPI.",
        "API /api/v1"
      ]
    ],
    "notes": "Tecnologias confirmadas por el PDF y por package.json de frontend/backend.",
    "sources": [
      "pdf",
      "repo"
    ]
  ...
  {
    "kicker": "03 | INFRAESTRUCTURA",
    "title": "Montaje de infraestructura",
    "subtitle": "La solucion esta pensada para iniciar localmente y evolucionar hacia contenedores, CDN y Kubernetes.",
    "expectedVisual": "Arquitectura de infraestructura.",
    "cards": [
      [
        "Entorno local",
        "El repositorio usa workspaces npm, variables .env.example, backend en puerto 3000 y frontend Vite para desarrollo."
      ],
      [
        "Base de datos",
        "MongoDB se levanta con docker-compose.mongo.yml e imagen definida en infra/mongo para pruebas locales."
      ],
      [
        "Despliegue objetivo",
        "Frontend y assets 3D servidos por CDN; API contenedorizada en Kubernetes; base de datos gestionada."
      ]
    ],
    "notes": "Explica el montaje actual y el destino de infraestructura planteado en el PDF.",
    "sources": [
      "pdf",
      "repo",
      "architecture"
  ...
  {
    "kicker": "04 | BACKEND",
    "title": "Backend: generalidades funcionales",
    "subtitle": "La API ya tiene estructura modular, seguridad base y dominios principales conectados a MongoDB.",
    "expectedVisual": "Modulos backend.",
    "cards": [
      [
        "Identidad",
        "Modulo IAM con login, refresh, logout, recuperacion, reseteo y cambio de contrasena mediante JWT y refresh tokens."
      ],
      [
        "Gestion academica",
        "Modulos de usuarios, roles, cursos, escenarios, inscripciones y progreso como base de administracion."
      ],
      [
        "Simulacion",
        "Endpoints para crear sesiones, registrar eventos en lote, completar intentos y consultar resultados."
      ]
    ],
    "notes": "El backend ya no es solo una idea: app.module.ts y el log evidencian modulos y rutas operativas.",
    "sources": [
      "repo",
      "log"
    ]
  ...
  {
    "kicker": "05 | FRONTEND",
    "title": "Frontend: experiencia implementada",
    "subtitle": "La interfaz ya cubre flujos administrativos, aprendizaje, autenticacion y simulacion 3D.",
    "expectedVisual": "Metricas frontend.",
    "metrics": [
      [
        "2",
        "Areas principales: administracion y portal de aprendizaje para estudiantes.",
        "Rutas /admin y /learn"
      ],
      [
        "7",
        "Secciones administrativas: dashboard, cursos, escenarios, inscripciones, usuarios, reportes y simulacion.",
        "App.tsx"
      ],
      [
        "3D",
        "Canvas Babylon.js con escenas de riego, ciclo hidrico, comparativa y panel electrico.",
        "SimulationCanvas.tsx"
      ]
    ],
    "notes": "El frontend contiene rutas protegidas, portal de aprendizaje y un runtime 3D funcional con interacciones.",
    "sources": [
      "repo"
    ]
  },
  {
    "kicker": "06 | AVANCE",
    "title": "Porcentaje de avance estimado",
    "subtitle": "Tomando como base el documento y lo implementado en el repositorio, el proyecto se estima en 45% de avance funcional.",
    "expectedVisual": "Calculo de avance.",
    "cards": [
      [
        "Base completada",
        "Documentacion, arquitectura, stack, modelo conceptual, OpenAPI inicial, estructura monorepo e infraestructura local."
      ],
      [
        "Funcionalidad parcial",
        "Backend y frontend tienen flujos reales, pero faltan evaluaciones completas, reportes finales, auditoria consultable y despliegue productivo."
      ],
      [
        "Lectura del 45%",
        "Supera el minimo del 30% solicitado porque ya existe integracion de modulos, rutas protegidas y simulacion 3D; aun no es solucion final."
      ]
    ],
    "notes": "Estimacion: 15% analisis/documentacion, 10% infraestructura local, 10% backend, 8% frontend, 2% integracion 3D. Pendiente hardening, evaluaciones, reportes, despliegue y pruebas amplias.",
    "sources": [
      "pdf",
      "repo",
      "architecture"
  ...
  {
    "kicker": "07 | ORGANIZACION",
    "title": "Reuniones y trabajo asignado",
    "subtitle": "La coordinacion del equipo se organizo por areas: documentacion, backend, frontend, infraestructura y validacion.",
    "expectedVisual": "Trabajo del equipo.",
    "cards": [
      [
        "Reuniones",
        "Levantamiento de alcance, seleccion tecnologica, revision de avances, validacion de interfaz y preparacion de entrega formal."
      ],
      [
        "Asignacion",
        "Glenda: documentacion y coordinacion. Diego: backend e infraestructura. Marcela: frontend y experiencia de usuario. Alisson: escenarios 3D y pruebas."
      ],
      [
        "Evidencia",
        "El documento base, el inventario de hardware y el repositorio muestran una division de trabajo alineada con el alcance academico."
      ]
    ],
    "notes": "La asignacion se formaliza para la presentacion tomando como base los nombres del equipo y las areas tecnicas del proyecto.",
    "sources": [
      "pdf",
      "repo"
    ]
  ...
  {
    "kicker": "08 | APLICACION REAL",
    "title": "Solucion para negocios",
    "subtitle": "La aplicacion demuestra como los lenguajes de programacion resuelven necesidades reales de capacitacion, control y medicion en organizaciones.",
    "expectedVisual": "Aplicacion a negocios.",
    "metrics": [
      [
        "Menor riesgo",
        "Capacitacion practica sin exponer al personal a fallos reales, equipos costosos o interrupciones operativas.",
        "Entrenamiento seguro"
      ],
      [
        "Mas control",
        "Usuarios, cursos, inscripciones, sesiones, eventos y progreso quedan centralizados para supervision.",
        "Trazabilidad"
      ],
      [
        "Escalable",
        "La arquitectura web permite ampliar contenidos, escenarios y grupos de usuarios con menor costo marginal.",
        "CDN + Kubernetes"
      ]
    ],
    "notes": "Cierre orientado a la materia: el proyecto aplica lenguajes y frameworks para resolver una necesidad concreta de negocio.",
    "sources": [
      "pdf",
      "architecture"
    ]
...
function addCard(slide, slideNo, x, y, w, h, label, body, { accent = ACCENT, fill = PAPER_96, line = INK, iconKind = "signal" } = {}) {
  ...
  const wrapped = wrapText(body, Math.max(34, Math.floor(w / 10)));
  const bodyY = y + 86;
...
function addReferenceCaption(slide, slideNo) {
  addText(
    slide,
    slideNo,
    "Interactive Lab | Plataforma de capacitacion virtual con simulacion 3D",
    64,
    674,
    980,
    22,
...
async function slideCover(presentation) {
  ...
  addText(slide, slideNo, [
    "Sandoval Orellana, Glenda Nicole | SO100122",
    "Perez Barrera, Diego Fernando | PB100123",
    "Recinos Ramirez, Marcela Alexandra | RR101423",
    "Mozo Chacon, Alisson Adriana | MC101123",
  ], 520, 440, 610, 122, {
    size: 13,
    color: GRAPHITE,
    face: BODY_FACE,
